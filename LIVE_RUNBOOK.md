...
- [ ] **Live-mini caps applied** — see the LIVE-MINI PROFILE block in `.env`.
      Uncomment those lines and verify with `docker exec grid-trader env | grep -E
      'DRY_RUN|BASE_ORDER_SIZE|MAX_CONCURRENT_GRIDS|DEFAULT_LEVERAGE'`.
