...
def _smart_close_config_from_env(**overrides) -> SmartCloseConfig:
    ...
    cfg = SmartCloseConfig(
        ...
        imbalance_emergency_ratio=_f("IMBALANCE_EMERGENCY_RATIO", 5.0),
        imbalance_emergency_min_fills=int(_f("IMBALANCE_EMERGENCY_MIN_FILLS", 5)),
        imbalance_emergency_min_loss_pct=_f("IMBALANCE_EMERGENCY_MIN_LOSS_PCT", 5.0),
